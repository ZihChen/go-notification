...
- [x] **技術文檔**
  - [x] 更新 `technical-details.md` (新增 Section 9: Pod 健康心跳機制, Section 10: 死 Pod 路由清理)
  - [x] 更新最後更新日期 (2026-02-09)

- [x] **運維文檔**
  - [x] 更新 `OPERATIONS_GUIDE.md` (新增監控指標、告警規則、故障排查步驟)
  - [x] 新增 Pod 健康與路由清理指標章節
  - [x] 新增 3 個故障排查案例 (Pod 健康心跳失敗、路由殘留、清理任務緩慢)
  - [x] 更新版本號 v1.1

- [x] **API 文檔**
  - [x] 更新錯誤處理說明 (新增 SSE 連接中斷、訊息延遲送達說明)
  - [x] 新增最佳實踐建議 (Pod 重啟與連接恢復完整指南)
  - [x] 新增訊息去重建議
  - [x] 更新版本號 v1.1
