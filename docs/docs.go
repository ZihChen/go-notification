    ...
    "paths": {
        "/api/v1/agent-campaigns": {
            "get": {
                ...
                "description": "分頁列出代理訊息活動，支持多條件篩選\n查詢參數說明：\n- page: 頁碼，從1開始，預設為1\n- page_size: 每頁數量，範圍1-100，預設為10\n- status: 狀態篩選，可選值：draft(草稿)、scheduled(已排程)、sent(已發送)、cancelled(已取消)、failed(發送失敗)\n- target_type: 目標類型篩選，可選值：all(全部代理)、specific(指定代理)、line(代理線)\n- created_by: 創建者篩選\n- include_deleted: 是否包含已刪除記錄，預設為false",
                "tags": [
                    "代理訊息活動"
                ],
                "summary": "列出代理訊息活動",
