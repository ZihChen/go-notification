...
type PlayerMessage struct {
	...
	PlayerID       uint64    `json:"player_id"        gorm:"uniqueIndex:idx_player_campaign;column:player_id;not null"`
	CampaignID     uint64    `json:"campaign_id"      gorm:"uniqueIndex:idx_player_campaign;column:campaign_id;not null"`
