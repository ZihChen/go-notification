...
type CreateMessageCampaignRequest struct {
	...
	TriggerType       string     `json:"trigger_type"                                 binding:"omitempty,oneof=success failure"                                                      example:"success"                      enums:"success,failure"`                                                                                                                        // 触发类型：success=成功，failure=失败（可选）。可選值：success, failure
