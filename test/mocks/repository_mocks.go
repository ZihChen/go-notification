...
func (m *PlayerTagRepositoryMock) DeleteByPlayerID(
	ctx context.Context,
	playerID uint64,
) error {
	args := m.Called(ctx, playerID)
...
func (m *AgentCampaignRepositoryMock) Delete(
	ctx context.Context,
	id uint64,
	updatedBy string,
) error {
...
func (m *AgentCampaignRepositoryMock) BatchDelete(
	ctx context.Context,
	ids []uint64,
	updatedBy string,
) error {
	args := m.Called(ctx, ids, updatedBy)
	return args.Error(0)
}
...
func (m *AgentMessageRepositoryMock) BatchHardDeleteByCampaignIDs(
	ctx context.Context,
	campaignIDs []uint64,
) error {
	args := m.Called(ctx, campaignIDs)
